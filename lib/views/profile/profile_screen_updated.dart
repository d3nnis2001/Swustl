...
import 'package:swustl/views/profile/profile_edit_screen.dart';
import 'dart:io';
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ProfileEditScreen(userData: widget.userData),
                  ),
                ).then((_) {
                  // Aktualisiere UI nach der Rückkehr
                  setState(() {});
                });
              },
            ),
