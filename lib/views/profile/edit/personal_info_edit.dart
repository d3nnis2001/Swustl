...
class _PersonalInfoEditScreenState extends State<PersonalInfoEditScreen> {
  ...
  void initState() {
    super.initState();
    // Vorausfüllen der Felder mit den aktuellen Daten
    ...
    // Falls ein Profilbild vorhanden ist
    if (widget.userData.profileImagePath != null) {
      _imageFile = File(widget.userData.profileImagePath!);
    }
  }
                      ...
                      onPressed: () {
                        if (_validateForm()) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Persönliche Informationen gespeichert'),
